...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterModule, FormsModule], // Assurez-vous que FormsModule est bien importé
  templateUrl: './etudiant.component.html',
  styleUrls: ['./etudiant.component.css']
})
export class EtudiantComponent implements OnInit {
  selectedEtudiant: any = { matricule: '', nom: '', prenom: '', filiere: '', montantInscription: null };  // Initialisation avec des valeurs vides ou nulles
  // Liste des étudiants
  etudiantList = [
